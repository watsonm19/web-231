...
; Description: This JavaScript program is intended to generate 10 random integers within an array. If the amount of even numbers generated within the array is seven (7) or greater, the program will print "You WIN!!!" otherwise, it will print "Sorry, you LOSE... try again".
; ** Program contains two (2) errors related to arrays **
===============================================
*/
